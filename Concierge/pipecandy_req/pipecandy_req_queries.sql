...
FROM 
  ...
  crunchbase_data.organizations cb_c on lk_cd_m.domain = cb_c.domain left join
...
UNION
 ...
 WHERE
 sub_text ~* '\yAVP Marketing\y|\yAVP Sales\y|\yCEO\y|\yCOO\y|\yCIO\y|\yCMO\y|\yCTO\y|\yChief Executive Officer\y|\yChief Information Officer\y|\yChief Marketing Officer\y|\yChief Sales Officer\y|\yChief Operating Officer\y|\yChief Product Officer\y|\yChief Technology Officer\y|\yCo Founder\y|\yCo-founder\y|\yCoFounder\y|\yFounder\y|\ySVP Marketing\y|\ySVP Sales\y|\yVP Marketing\y|\yVP Sales\y|\yVice President Marketing\y|\yVice President Sales\y'
 )
)x;
