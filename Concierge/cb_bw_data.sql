...
SELECT DISTINCT ON (lower(cb_c.company_name))
  cb_c.domain, 
...
WHERE
    ...
    ((cb_c.domain != '' and bw_c."Domain" != '') or (lower(cb_c.company_name) = lower(bw_c."Company"))) or cb_c.domain is null or cb_c.domain = ''
   ;
