...
import urllib2
import requests #requests installed using sudo pip2 install 'requests[security]'
                #refer http://stackoverflow.com/questions/29849892/error-installing-any-module-using-pip-but-easy-install-works
import pdb
