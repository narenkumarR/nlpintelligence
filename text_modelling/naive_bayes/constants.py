...
# -*- coding: utf-8 -*-
__author__ = 'joswin'
#  stop_words_vectorizer, stop_phrases : removed directly
# replace_phr_input : key:value dict. Keys will be replaced by value in the text
# merege_phr_list : these phrases will be merged to create single token
# merge_words_with_next : these phrases will be merged with next word
...
# merge_phr_list_remove_original = ['no need', 'no relevant'
